...
async def help_cmd(update: Update, context: CallbackContext):
    ...
    🔍 <b>Части слов</b> - можно использовать *: <code>математи* задач*</code>
    ...
    🔍 <b>Поиск по аннотациям</b> - в настройках включите "Область поиска" → "по аннотации книг" или "по аннотациям авторов"
    ...
    ✏ <code>"умер 2000 году" @5</code> - авторы, умершие в 2000 году (слова в пределах 5 слов друг от друга)
    ✏ <code>+(родился умер проживал) +Пензенской +губернии</code> - авторы, связанные с Пензенской губернией
